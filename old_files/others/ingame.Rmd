...
```{r}
game=read.csv("/Users/marcusthuillier/Desktop/Rugby/Excel/Games/InGameIREN.csv", header=T)
game
```
...
full_game %>%
  ...
  geom_line(size = 1) +
  scale_color_manual(values = c("#2ebf49", "#000000"),
    labels = c("Ireland", "England")) +
  scale_y_continuous(limits = c(0, 1), breaks = seq(0, 1, by = 0.1),
    labels = paste0(seq(0, 100, by = 10), "%")) +
  scale_x_continuous(limits = c(0, 80), breaks = seq(0, 80, 4),
    labels = paste0(seq(80, 0, -4))) +
  labs(title = "Ireland 00 – 00 England, 2 Feb 2019", y = "Win Probability", x = "Minutes Remaining") +
  theme_minimal() +
